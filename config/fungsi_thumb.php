...
// Upload gambar untuk Forum
function UploadForum($fupload_name){
  //direktori gambar
  $vdir_upload = "../../../foto_forum/";
  $vfile_upload = $vdir_upload . $fupload_name;
  $tipe_file   = $_FILES['fupload']['type'];
...
//BUAT SMILEY
function Uploadsmiley($fupload_name){
  //direktori smiley
  $vdir_upload = "../../../smiley/";
  $vfile_upload = $vdir_upload . $fupload_name;
  $tipe_file   = $_FILES['fupload']['type'];
...
// Upload gambar untuk album1 galeri foto1
function UploadAlbum1($fupload_name){
  //direktori gambar
  $vdir_upload = "../../../img_album1/";
$vfile_upload = $vdir_upload . $fupload_name;
  $imageType = $_FILES["fupload"]["type"];
...
// Upload gambar untuk galeri foto1
function UploadGallery1($fupload_name){
  //direktori gambar
  $vdir_upload = "../../../img_galeri1/";
  $vfile_upload = $vdir_upload . $fupload_name;
  $imageType = $_FILES["fupload"]["type"];
...
function Uploadplaycorel($fupload_name){

  //direktori gambar

  $vdir_upload = "../../../img_playcorel/";
 ...
 //BUAT corel
function UploadCorel($fupload_name){
  //direktori gambar
  $vdir_upload = "../../../img_corel/";
  $vfile_upload = $vdir_upload . $fupload_name;
  $imageType = $_FILES["fupload"]["type"];
...
///////////////////////////////////////////////
function UploadCorel2($fupload_name){
  //direktori gambar
  $vdir_upload = "../../../img_corel/";
  $vfile_upload = $vdir_upload . $fupload_name;
...
// Playdio /////////////////////////////////////////////////////////// 
function Uploadplaydio($fupload_name){
  //direktori gambar
  $vdir_upload = "../../../img_playdio/";
   $vfile_upload = $vdir_upload . $fupload_name;
  $imageType = $_FILES["fupload"]["type"];
  //Simpan gambar dalam ukuran sebenarnya
  move_uploaded_file($_FILES["fupload"]["tmp_name"], $vfile_upload);
